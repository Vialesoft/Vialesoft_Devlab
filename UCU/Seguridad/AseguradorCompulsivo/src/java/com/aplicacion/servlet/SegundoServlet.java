...
public class SegundoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String vector = pass.substring(16, 32);
        ...
        String nombreArchivo = Paths.get(archivo.getSubmittedFileName()).getFileName().toString();
            ...
            try {
                if (encriptar) {
                    ...
                    bytesProcesados = EncriptacionYHasheo.EncriptacionYHasheo.encrypt(pass, vector, bytes);
                    ...
                    bytesProcesados = EncriptacionYHasheo.EncriptacionYHasheo.decrypt(pass, vector, bytes);
