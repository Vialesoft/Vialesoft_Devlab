...
showGame (MartianChessGame board player points moves) = (prettyMatrix (((fromLists [[X 1],[X 2],[X 3],[X 4]]) <|> board) <-> (fromLists [[Chess, Y 1, Y 2, Y 3, Y 4, Y 5, Y 6, Y 7, Y 8]]))) ++ "\r\nactive player -> " ++ (show player) ++ " points: " ++ (show points) ++ " moves left: " ++ (show moves) 
