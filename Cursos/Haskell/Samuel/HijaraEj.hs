...
showBoard elJuego = show (elJuego)
...
escalera ficha lista@([a,b,c,d]) = mismaEscalera ficha (a!!0) (b!!1) (c!!2) (d!!3) + mismaEscalera ficha (a!!3) (b!!2) (c!!1) (d!!0) 
    
mismaFicha ficha a b c d 
   | a == b && b == c && c == d  && d == ficha = 10
   | otherwise = 0

mismaEscalera ficha a b c d 
   | a == b && b == c && c == d  && d == ficha = 15
   | otherwise = 0
